...
//            var keyword = $("#keyword").val();
        ...
        function reloadGrid() {
            window.location.href = "${basePath}/offtimeCheck/list.do";
        }
        function toSee(id) {
    ...
    <table class="table table-striped table-bordered table-hover" style="width: 1200px;">
        ...
        <c:forEach items="${offtimeRecords}" var="offtimeRecord" varStatus="status">
            <tr align="center">
                ...
                <td>
                    <button id="addWGTask" onclick="check(1,${offtimeRecord.id});" type="button" id="btn_search"
                            class="btn btn-warning btn-sm">
                        <i class="ace-icon fa bigger-110"></i>
                        同意
                    </button>
                    <button id="addWGTask" onclick="check(2,${offtimeRecord.id});" type="button" id="btn_search"
                            class="btn  btn-sm">
                        <i class="ace-icon fa bigger-110"></i>
                        驳回
                    </button>
