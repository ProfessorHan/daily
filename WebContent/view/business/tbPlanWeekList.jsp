...
<head>
    ...
    <script>
        ...
        //导出周计划
        function excelPrint() {
            var url = "${basePath}/tbPlan/excel.do";
            window.location.href = url;
        }
        //导出周总结
        function excelSum() {
            var url = "${basePath}/tbPlan/sum.do";
            window.location.href = url;
        }
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="project_name" id="project_name"
                                               value="${project_name }" class="form-control search-query"
                                               placeholder="请输入关键字"/>
            ...
            <div class="col-xs-12">
                <div class="row-fluid" style="margin-bottom: 5px;">
                    <div class="span12 control-group">
                        <button onclick="excelPrint();" type="button" id="btn_search" class="btn btn-primary btn-sm">
                            <span class="ace-icon glyphicon glyphicon-plus icon-on-right"></span>
                            Excel导出周计划
                        </button>
                        <button id="addTask" onclick="excelSum();" type="button" id="btn_search"
            ...
            <c:forEach items="${tbPlan}" var="plan" varStatus="status">
                <tr align="center">
                    ...
                    <c:if test="${plan_type==10}">
                        ...
                        <td>
                            <button id="Update" onclick="Update(${plan.id});" type="button" id="btn_search"
                                    class="btn btn-info btn-sm">
                                <span class="ace-icon fa fa-pencil-square-o bigger-110"></span>
                                编辑
                            </button>
                            <button id="addWGTask" onclick="toSee(${plan.id});" type="button" id="btn_search"
                                    class="btn btn-sm">
                                查看工作计划
                            </button>
                        </td>
