										...
										<div class="step-content pos-rel" id="step-container">
											<div class="step-pane active" id="step1">
												<form class="form-horizontal" id="validation-form" method="post">
													...
													<input name="dict_id" id="dict_id" type="hidden" value="${dict_id}" />
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right">名称:</label>
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																<input type="text" name="data_value" id="data_value" value="${item.data_value }" class="col-xs-12 col-sm-6">
															</div>
														</div>
													</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
	        ...
	        $('#validation-form').validate({
	            ...
	            focusInvalid : false,
	            rules : {
	            	data_value : { required : true } },
	            messages : {
	            	data_value : { required : "请输入数据" } },
