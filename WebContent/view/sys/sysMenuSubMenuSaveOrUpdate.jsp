                                        ...
                                        <div class="step-pane active" id="step1">
                                            <form class="form-horizontal" id="validation-form" method="post">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="name" id="name"
                                                                   value="${bean.name }" class="col-xs-12 col-sm-6">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right">URL地址:</label>
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                ...
                                                <input type="hidden" name="deleted" id="deleted" value="0"
                                                       class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right">排序(数字越大，位置越靠前):</label>
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="rank" id="rank"
                                                                   value="${bean.rank }" class="col-xs-12 col-sm-6">
                                                        </div>
                                                    </div>
                                                </div>
