														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																<input type="text" name="email" id="email"
																	value="${data.email }" class="col-xs-12 col-sm-6">
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																<input type="text" name="nickName" id="nickName"
																	value="${data.nickName }" class="col-xs-12 col-sm-6">
															</div>
														</div>
													</div>
													<%-- <div class="form-group">
														<label
															class="control-label col-xs-12 col-sm-3 no-padding-right">角色:</label>
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
															<select name="">
		...
		jQuery(function($) {
	        ...
	        $('#validation-form').validate({
	            ...
	            messages : {
	            	...
	            	nickName : { required : "请输入真实姓名" },
	            	dept_id : { required : "请输入部门Id" }},
