...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="${basePath}/js/omui/development-bundle/themes/default/om-fileupload.css"/>
    ...
    jQuery(function ($) {
        ...
        $('#validation-form')
            .validate({
                ...
                rules: {
                    oldPwd: {required: true, minlength: 4},
                    newPwd: {required: true, minlength: 4},
                    pwdRepeat: {required: true, minlength: 4}
                },
                messages: {
                    oldPwd: {required: "请输入旧密码", minlength: "旧密码长度最少为4位"},
                    newPwd: {required: "请输入新密码", minlength: "新密码长度最少为4位"},
                    pwdRepeat: {required: "请输入重复密码", minlength: "重复密码长度最少为4位"}
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.post('${basePath}/modifyPwd.do', submitData, function (data) {
                        ...
                        if (data.success) {
                            layer.msg(
                                ...
                                function () {
                                    parent.window.location.href="${basePath}/logout.do";
                                });
                        } else {
                            layer.msg(
                                data.msg,
