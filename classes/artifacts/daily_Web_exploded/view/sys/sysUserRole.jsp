...
<body>
	...
	<div class="actions" style="margin-left: 300px; margin-top: 30px;">
		...
		<button type="button" class="btn btn-sm btn-primary" id="btn_saveOrder">
...
<![endif]-->
	...
	<script type="text/javascript" src="${basePath}/js/ztree/js/jquery.ztree.core-3.5.min.js"></script>
	<script type="text/javascript" src="${basePath}/js/ztree/js/jquery.ztree.excheck-3.5.min.js"></script>
	<script type="text/javascript" src="${basePath}/js/ztree/js/jquery.ztree.exedit-3.5.min.js"></script>
	<script type="text/javascript">
		...
		$(function() {
	        ...
	        $("#btn_saveOrder").click(function() {
		        ...
		        var submitData = {
		            "roleIds" : selectIds,
		            "userid" : "${userid}" }
		        $.post("saveRole.do", submitData, function(data) {
