                                ...
                                <div class="widget-main">
                                    <div class="step-content pos-rel" id="step-container">
                                        <div class="step-pane active" id="step1">
                                            ...
                                            <form class="form-horizontal" id="validation-form" style="text-align: center" method="post" action="${pageContext.request.contextPath}/ExportExcel/exprot.do">
            ...
            .validate(
                {
                    ...
                    submitHandler: function (form) {
                        ...
                        /*layer.confirm('确认导出?', function(){
                            ...
                            //$("#validation-form").sumbit;


                            /!*$.post('${pageContext.request.contextPath}/ExportExcel/exprot.do', postData, function (data) {
