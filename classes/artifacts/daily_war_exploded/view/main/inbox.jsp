														...
														<div class="message-toolbar hide">
															<div class="inline position-relative align-left">
																...
																<ul class="dropdown-menu dropdown-lighter dropdown-caret dropdown-125">
																	...
																	<li>
																		<a href="#">
																			<i class="ace-icon fa fa-flag-o red"></i>
																			&nbsp; Flag
																		</a>
																	</li>
															...
															<div class="inline position-relative align-left">
																...
																<ul class="dropdown-menu dropdown-lighter dropdown-caret dropdown-125">
																	...
																	<li>
																		<a href="#">
																			<i class="ace-icon fa fa-stop blue"></i>
																			&nbsp; Family
																		</a>
																	</li>
																	...
																	<li>
																		<a href="#">
																			<i class="ace-icon fa fa-stop grey"></i>
																			&nbsp; Work
																		</a>
																	</li>
																</ul>
													...
													<div class="message-list" id="message-list">
														...
														<div class="message-item message-unread">
															...
															<span class="summary">
																...
																<span class="text"> Clik to open this message right here </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																...
																<span class="text"> Photo booth beard raw denim letterpress vegan </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																<span class="text"> Nullam quis risus eget urna mollis ornare </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																...
																<span class="text"> Vestibulum id ligula porta felis euismod </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																<span class="text"> Vim te vivendo convenire, summo fuisset </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																...
																<span class="text"> No eos veniam equidem mentitum, his porro </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																...
																<span class="text"> Convallis facilisis euismod urna sodales </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																...
																<span class="text"> Photo booth beard raw denim letterpress vegan messenger </span>
															</span>
														</div>
														...
														<div class="message-item">
															...
															<span class="summary">
																...
																<span class="text"> Tofu biodiesel williamsburg marfa, four loko mcsweeney </span>
															</span>
														</div>
						...
						<form id="id-message-form" class="hide form-horizontal message-form col-xs-12">
							...
							<div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<span class="input-icon">
											<input type="email" name="recipient" id="form-field-recipient" data-value="alex@doe.com" value="alex@doe.com"
