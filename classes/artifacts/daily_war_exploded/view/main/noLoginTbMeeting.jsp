...
<head>
    ...
    <script>
        ...
        function goPage(page) {
            url = "${basePath}/noLoginTbMeeting.do";
            var year = $("#year").val();
            var month = $("#month").val();
            $("body").load(url,{"year":year,"month":month});
        }
        ...
        function contextDisplay(id) {
            layer.open({
                ...
                fix: false, //不固定
                maxmin: true,
                content: "/noLoginTbMeetingContext.do?id=" + id
            });
        }
            ...
            <table class="table table-striped table-bordered table-hover"
                ...
                <c:forEach items="${tbMeetings}" var="tbMeeting" varStatus="status">
                    <tr align="center">
                        ...
                        <td><fmt:formatDate value="${tbMeeting.meetingCreateTime}" pattern="yyyy-MM-dd"/></td>
