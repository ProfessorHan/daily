												...
												<form class="form-horizontal" id="validation-form" method="post">
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																<input type="text" name="dict_name" id="dict_name" value="${item.dict_name }" class="col-xs-12 col-sm-6">
															</div>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right">key:</label>
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																<input type="text" name="dict_key" id="dict_key" value="${item.dict_key }"
	...
	<script type="text/javascript">
		jQuery(function($) {
	        ...
	        $('#validation-form').validate({
	            ...
	            messages : {
	            	dict_name : { required : "请输入名称" },
	            	dict_key : { required : "请输入key" } },
